...
module.exports.initDb = function (appPath, callback) {
  ...
  if (db === null) {
   ...
   console.log("hello");
    ...
    } else { console.log('The database has', tableCount, 'tables.'); }
...
console.log(db);
    ...
    try {
      let row = db.exec(query); //db.exec(query) returns an array
      
      console.log(row);  //row is an array
